...
public class Trajectory : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        RaycastHit2D[] circleCastHit2DArray = Physics2D.CircleCastAll(ballRb.position, ballColider.radius, ballRb.velocity.normalized);
        ...
        foreach (RaycastHit2D circleCastHit2D in circleCastHit2DArray)
        {
            ...
            if (circleCastHit2D.collider != null &&
                circleCastHit2D.collider.GetComponent<Ball>() == null)
            {
                ...
                offsetHitPoint = hitPoint + hitNormal * ballColider.radius;
                ...
                if (circleCastHit2D.collider.GetComponent<Wall>() == null)
                {
